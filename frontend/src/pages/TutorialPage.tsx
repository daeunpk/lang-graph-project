...
const SLIDES = [
  ...
  },
  {
    title: "카드와 보드",
    content: [
      "각 카드에는 번호(1~5)와 구역(색상)이 있습니다. 일부 카드는 오정보일 수 있습니다.",
      "각 구역은 1번부터 순서대로 카드를 설치해야 합니다. 4번까지 완성하면 기본 목표를 달성하고, 5번은 추가 성과로 인정됩니다.",
  ...
  },
  {
    title: "점수와 보상",
    content: [
      "팀 점수는 각 구역에서 설치된 가장 높은 번호를 더해 계산합니다.",
      "20점은 기본 완성 목표, 25점은 완벽 완성입니다.",
      "보상 구조는 선택한 시나리오에 따라 다르게 적용됩니다.",
    ],
  },
];
